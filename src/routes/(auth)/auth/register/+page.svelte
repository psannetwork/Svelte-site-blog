...
<div class="w-full max-w-md px-4 py-20">
	<div class="card-psan p-8 md:p-12 shadow-2xl shadow-psan-green/5 relative overflow-hidden group">
		...
		<div class="relative z-10 text-center mb-10">
			<div
				class="w-16 h-16 bg-psan-pink rounded-2xl mx-auto mb-6 flex items-center justify-center font-black text-white text-3xl italic rotate-12 shadow-lg shadow-psan-pink/20"
			>
				P.
			</div>
			...
			<form method="POST" use:enhance class="space-y-6 relative z-10">
				<div class="space-y-4">
					<div class="space-y-2">
						<label
							for="username"
							class="text-[10px] font-black tracking-widest text-muted uppercase">User ID</label
						>
						<input
							id="username"
							name="username"
					...
					<div class="space-y-2">
						<label
							for="password"
							class="text-[10px] font-black tracking-widest text-muted uppercase">Password</label
						>
						<input
							id="password"
							name="password"
				...
				<button
					type="submit"
					class="btn-psan bg-psan-pink text-white w-full py-4 text-lg font-black rounded-2xl shadow-lg shadow-psan-pink/20 hover:scale-[1.02] active:scale-[0.98] transition-all"
				>
					Register
				</button>
			</form>
