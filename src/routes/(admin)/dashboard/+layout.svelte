		...
		>
			<div class="flex items-center gap-4">
				<button
					...
					class="lg:hidden p-2 bg-slate-100 dark:bg-slate-700 border border-slate-200 dark:border-slate-500 rounded-xl text-main"
					aria-label="メニューを開く"
				>
					<svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"
						><path
			...
			<div class="flex items-center gap-3 md:gap-6">
				...
				<a
					href="/account"
					class="flex items-center gap-3 sm:pl-6 sm:border-l border-[--border-color] group"
				>
