...
<div class="max-w-7xl mx-auto space-y-8 md:space-y-12">
	...
	<div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
		<div
			class="card-psan p-6 md:p-8 bg-psan-green text-white border-none shadow-psan-green/20 shadow-xl relative overflow-hidden group"
		>
			<div
			...
			<div class="relative z-10">
				<div class="text-[10px] font-black tracking-[0.2em] uppercase opacity-60 mb-2">
					Total Access
				</div>
				<div class="text-4xl md:text-6xl font-black tracking-tighter">
					{stats.totalHits.toLocaleString()}
				</div>
			</div>
		</div>
		<div class="card-psan p-6 md:p-8">
			<div class="text-[10px] font-black tracking-[0.2em] uppercase text-psan-green mb-2">
				Today's Hits
			</div>
			<div class="text-4xl md:text-5xl font-black text-main tracking-tighter">
				{stats.todayHits.toLocaleString()}
			</div>
		</div>
		<div class="card-psan p-6 md:p-8">
			<div class="text-[10px] font-black tracking-[0.2em] uppercase text-psan-pink mb-2">
				Today's Uniques
			</div>
			<div class="text-4xl md:text-5xl font-black text-main tracking-tighter">
	...
	<div class="grid grid-cols-1 lg:grid-cols-2 gap-8 pb-20">
		...
		<section class="space-y-4">
			<h3 class="font-black text-xs tracking-widest text-psan-pink uppercase px-2">
				Recent Comments
			</h3>
			<div class="card-psan divide-y border-[--border-color]">
				{#each data.comments.slice(0, 3) as comment}
					<div class="p-5 md:p-6">
						<div class="flex justify-between items-center mb-1">
							...
							<span class="text-[9px] font-black text-muted"
