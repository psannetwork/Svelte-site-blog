...
<article class="relative pt-20 pb-20 overflow-hidden transition-colors">
	<div class="max-w-7xl mx-auto px-4 relative">
		<div class="max-w-5xl prose prose-xl dark:prose-invert prose-headings:font-black prose-headings:tracking-tighter prose-p:font-medium prose-img:rounded-[40px] prose-img:shadow-2xl">
			{@html data.homeHtml}
		</div>
	</div>
</article>
